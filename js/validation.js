                ...
                if (jsonData.success){
                    ...
                    jsonData.data.forEach(element => {
                        ...
                        `<tr>
                            ...
                            <td>
                                <span  data-bs-toggle="modal" data-bs-target="#schooModal" class="action-button" onClick="onEditSchool(${element.id})" >Edit</span> | <span class="action-button">Delete</span> 
                            </td>
                        </tr>`;
