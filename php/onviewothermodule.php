<?php
    ...
    FROM tbl_module RIGHT JOIN tbl_account_profile ON tbl_account_profile.id = tbl_module.teacher_id WHERE tbl_module.subject_id = '$subject_id' AND tbl_module.school_id = '$school_id'");
